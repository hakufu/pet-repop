...
module.exports = function PetRepop(mod) {
	let petId = BigInt(0);
	var timer = null;
	var feedTimer = null;
	...
	mod.hook('S_REQUEST_SPAWN_SERVANT', 1, (e) => { if(mod.game.me.is(e.ownerId) && e.type == 1) { petId = e.gameId; } });
	...
	mod.command.add('prp', (cmd, arg) => {
		switch(cmd) {
			...
			case 'help':
				mod.command.message('\n<font color="#00CC00">Available commands:</font>\n<font color="#00CC00">prp feed</font> - Toggle auto feed\n<font color="#00CC00">prp food</font> - Set food type for auto feed\n<font color="#00CC00">prp skill [skillname]</font> - Set skill to use on activation\n<font color="#00CC00">prp use [skillname]</font> - Use skill once\n<font color="#00CC00">prp</font> - Toggle script on/off\n<font color="#00CC00">prp power [amount]</font> - Set which power buff to use (3-40)\n<font color="#00CC00">prp reuse</font> - Toggle automatic skill reuse\n<font color="#00CC00">prp settings</font> - Show your current settings');
			break;
